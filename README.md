...
Al abrir la app, se cargarán automáticamente los datos desde `productos.txt` y `clientes.txt`.
...
- Se genera un comprobante digital y la transacción se guarda en el Historial.
